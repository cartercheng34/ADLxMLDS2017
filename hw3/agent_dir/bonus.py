...
class Agent_DQN(Agent):
    def __init__(self, env, args):
        ...
        self.DQN = DoubleDQN(env, args.test_dqn)
        self.resume = False
        self.args = args
    ...
    def train(self):
        ...
        for i in range(total_steps):
            ...
            if (step_count > 100000) and (step_count % 100000 == 0):
                self.DQN.save_model('model_doudqn/model.ckpt', int(step_count/1000))
                np.save('model_doudqn/record.npy', [step_count, frame_count, learn_count, episode_count, episode_reward, self.DQN.memory_count, self.DQN.learn_step_count, self.DQN.epsilon])
